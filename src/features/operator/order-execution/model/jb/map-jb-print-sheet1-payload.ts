...
/** Извлекает `fileName` из ответа jbPrintSheet1 и собирает URL с `pathFolder` окружения. */
export function mapJbPrintSheet1Payload(
    payload: ApiSchemas["JbPrintSheet1Response"] | undefined,
    pathFolder: string,
): string {
