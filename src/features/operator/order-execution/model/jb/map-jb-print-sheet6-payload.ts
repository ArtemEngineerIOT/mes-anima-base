...
/** Извлекает `fileName` из ответа jbPrintSheet6 и собирает URL с `pathFolder` окружения. */
export function mapJbPrintSheet6Payload(
    payload: ApiSchemas["JbPrintSheet6Response"] | undefined,
    pathFolder: string,
): string {
