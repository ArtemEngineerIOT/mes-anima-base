...
/** Извлекает `fileName` из ответа jbPrintSheet2 и собирает URL с `pathFolder` окружения. */
export function mapJbPrintSheet2Payload(
    payload: ApiSchemas["JbPrintSheet2Response"] | undefined,
    pathFolder: string,
): string {
