...
/** Извлекает `fileName` из ответа jbPrintSheet3 и собирает URL с `pathFolder` окружения. */
export function mapJbPrintSheet3Payload(
    payload: ApiSchemas["JbPrintSheet3Response"] | undefined,
    pathFolder: string,
): string {
