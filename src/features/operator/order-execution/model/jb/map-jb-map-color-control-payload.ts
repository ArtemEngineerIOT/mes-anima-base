...
/** Извлекает `fileName` из ответа jbMapColorControl и собирает URL с `pathFolder` окружения. */
export function mapJbMapColorControlPayload(
    payload: ApiSchemas["JbMapColorControlResponse"] | undefined,
    pathFolder: string,
): string {
