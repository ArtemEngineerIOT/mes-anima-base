...
export type MaterialOrderSubmitBlockResult = {
    message: string;
    requestStatus: string;
};

export function mapMaterialOrderSubmitBlockPayload(
    payload: ApiSchemas["SubmitBlockResponse"] | undefined,
): MaterialOrderSubmitBlockResult {
    ...
    const message =
        pickString(result ?? {}, "display_message", "displayMessage") ||
        "Блокировка принята";
